...
def create_visualizations(simulation_results, cvr_results, cvr_params, heston_params,
...
def export_results(simulation_results, cvr_results, cvr_params, heston_params, sim_params,
